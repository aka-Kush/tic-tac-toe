...
const Board = ({tiles, onTileClick, playerTurn, strikeClass}) => {
  return (
    <div className='board'>
      {/* Board component
          playerTurn specifies which playerturn it is right now: X, O
          onClickFunction gives us the index of tile being clicked
          value stores the corresponsing value of tile: X, O, null
      */}
